    ...
    <div class="flex flex-column justify-content-center align-items-center">
        ...
        <?php endif; ?>
            ...
            <div class="date-end">
                ...
                <input type="datetime-local" value="<?php echo e($survey->ended_at ?? ''); ?>" name="ended_at" id="ended_at" class="form-control" required>
            </div>
...
<?php echo $__env->make('templates.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TR\Documents\tayouza-survey\resources\views/create.blade.php ENDPATH**/ ?>